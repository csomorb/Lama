...
if (!empty($_POST)) {
	...
	foreach ($_POST as $key => $value){
		...
		echo "La grande lettre: <input type=\"text\" name=\"".$value."_grande_lettre\" value=\""."ne pas utiliser"."\"/><br/>\n";
		echo "Texte affiché en gras: <br/><textarea name=\"".$value."_contenu_gras\" rows=\"15\" cols=\"100\">"."ne pas utiliser"."</textarea> <br/>\n";
		echo "Tout le texte en normal: <br/>\n";
